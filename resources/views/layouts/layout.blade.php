        ...
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="/">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item dropdown"><a aria-expanded="false" data-toggle="dropdown" class="nav-link" href="#"><i class="fa fa-money"></i><span>Ventas</span></a>
                    <div class="dropdown-menu"><a class="dropdown-item" href="/ventasgeneral">Ventas General</a><a class="dropdown-item" href="/ventashoy">Ventas de hoy</a><a class="dropdown-item" href="#">Ventas De la semana</a></div>
                </li>
                @endif
